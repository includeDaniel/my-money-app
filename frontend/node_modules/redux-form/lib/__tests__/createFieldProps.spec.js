...
var describeCreateFieldProps = function describeCreateFieldProps(name, structure, expect) {
  ...
  describe(name, function () {
    ...
    it('should provide onBlur', function () {
      ...
      var result = (0, _createFieldProps2.default)(getIn, 'foo', { value: 'bar', onBlur: onBlur });
    ...
    it('should provide onChange', function () {
      ...
      var result = (0, _createFieldProps2.default)(getIn, 'foo', { value: 'bar', onChange: onChange });
    ...
    it('should provide onFocus', function () {
      ...
      var result = (0, _createFieldProps2.default)(getIn, 'foo', { value: 'bar', onFocus: onFocus });
    ...
    it('should provide onDragStart', function () {
      ...
      var result = (0, _createFieldProps2.default)(getIn, 'foo', { value: 'bar', onDragStart: onDragStart });
      expect(result.input.onDragStart).toBeA('function');
    });

    it('should provide onDrop', function () {
      var onDrop = (0, _expect.createSpy)();
      var result = (0, _createFieldProps2.default)(getIn, 'foo', { value: 'bar', onDrop: onDrop });
